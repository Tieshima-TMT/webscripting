...
function showList() {
	...
	if(enable == false) {
		...
		imList.innerHTML = "<p>This is the list:</p><ul style=\"list-style-type:none;\"><li>String</li> <li>" + rinlen.titles + "</li> <li>" + rinlen.color + "</li></ul>";
		enable = false;
	}
	return enable;
}
...
rinlen.total = function() {
	...
	function add() {
		...
		var results2 = r_albums + l_albums;
		return results1;
	}
	return add();
};
